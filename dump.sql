...
--
-- Host: localhost    Database: bd_games
-- ------------------------------------------------------
...
INSERT INTO `produtoras` VALUES (1,'Microsoft','EUA'),(2,'Tencent','China'),(3,'Nintendo','Japão'),(4,'Sony','Japão'),(5,'Activision','EUA'),(6,'EA','EUA'),(7,'Sega','Japão'),(8,'Namco Bandai','Japão'),(9,'Konami','Japão'),(10,'Ubisoft','EUA'),(11,'Valve','EUA'),(12,'Square Enix','Japão'),(13,'Take Two','EUA'),(14,'Capcom','Japão');
...
INSERT INTO `usuarios` VALUES ('admin','Vinicius Leite','$2y$10$cu3YgwaIJmXsRZYxlSYMzufLf5w4C1dkgA32aIMOkare4GUd5uoNa','admin'),('teste','Gustavo da Silva','$2y$10$xi2TmCQUECxEM9zab4FAzehItkAlUX.mNcRekE2JVcq0TiTokxe6y','editor');
...
-- Dump completed on 2022-06-10 15:50:16
